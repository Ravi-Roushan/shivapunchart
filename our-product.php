...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal21"><div class="carousel-inner"><div class="carousel-item active"><img alt="Mag Etg Foil Block" class="d-block w-100 product-img" src="assets/img/our-products/electro-etched-foil-block/01-elecro-etg-foil-block.jpg"/><button aria-label="View Mag Etg Foil Block" class="product-image-click-target" data-image-alt="Mag Etg Foil Block" data-image-src="assets/img/our-products/electro-etched-foil-block/01-elecro-etg-foil-block.jpg" type="button"></button></div><div class="carousel-item"><img alt="Mag Etg Foil Block" class="d-block w-100 product-img" src="assets/img/our-products/electro-etched-foil-block/02-elecro-etg-foil-block-3.jpg"/><button aria-label="View Mag Etg Foil Block" class="product-image-click-target" data-image-alt="Mag Etg Foil Block" data-image-src="assets/img/our-products/electro-etched-foil-block/02-elecro-etg-foil-block-3.jpg" type="button"></button></div><div class="carousel-item"><img alt="Mag Etg Foil Block" class="d-block w-100 product-img" src="assets/img/our-products/electro-etched-foil-block/03-elecro-etg-foil-block-4.jpg"/><button aria-label="View Mag Etg Foil Block" class="product-image-click-target" data-image-alt="Mag Etg Foil Block" data-image-src="assets/img/our-products/electro-etched-foil-block/03-elecro-etg-foil-block-4.jpg" type="button"></button></div><div class="carousel-item"><img alt="Mag Etg Foil Block" class="d-block w-100 product-img" src="assets/img/our-products/electro-etched-foil-block/04-elecro-etg-foil-block-5.jpg"/><button aria-label="View Mag Etg Foil Block" class="product-image-click-target" data-image-alt="Mag Etg Foil Block" data-image-src="assets/img/our-products/electro-etched-foil-block/04-elecro-etg-foil-block-5.jpg" type="button"></button></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal21" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal21" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
