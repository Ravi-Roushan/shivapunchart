...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal17"><div class="carousel-inner"><div class="carousel-item active"><img alt="Sandwich Dies" class="d-block w-100 product-img" src="assets/img/Pertinax/P1.jpg"/><button aria-label="View Sandwich Dies" class="product-image-click-target" data-image-alt="Sandwich Dies" data-image-src="assets/img/Pertinax/P1.jpg" type="button"></button></div><div class="carousel-item"><img alt="Sandwich Dies" class="d-block w-100 product-img" src="assets/img/Pertinax/P2.jpg"/><button aria-label="View Sandwich Dies" class="product-image-click-target" data-image-alt="Sandwich Dies" data-image-src="assets/img/Pertinax/P2.jpg" type="button"></button></div><div class="carousel-item"><img alt="Sandwich Dies" class="d-block w-100 product-img" src="assets/img/Pertinax/P3.jpg"/><button aria-label="View Sandwich Dies" class="product-image-click-target" data-image-alt="Sandwich Dies" data-image-src="assets/img/Pertinax/P3.jpg" type="button"></button></div><div class="carousel-item"><img alt="Sandwich Dies" class="d-block w-100 product-img" src="assets/img/Pertinax/P4.jpg"/><button aria-label="View Sandwich Dies" class="product-image-click-target" data-image-alt="Sandwich Dies" data-image-src="assets/img/Pertinax/P4.jpg" type="button"></button></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal17" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal17" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal18"><div class="carousel-inner"><div class="carousel-item active"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" src="assets/img/Corrugation-Die/cor2.png"/><button aria-label="View Blanking Die Male Female" class="product-image-click-target" data-image-alt="Blanking Die Male Female" data-image-src="assets/img/Corrugation-Die/cor2.png" type="button"></button></div><div class="carousel-item"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" src="assets/img/Corrugation-Die/cor3.png"/><button aria-label="View Blanking Die Male Female" class="product-image-click-target" data-image-alt="Blanking Die Male Female" data-image-src="assets/img/Corrugation-Die/cor3.png" type="button"></button></div><div class="carousel-item"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" src="assets/img/Critical-Die/shape1.jpeg"/><button aria-label="View Blanking Die Male Female" class="product-image-click-target" data-image-alt="Blanking Die Male Female" data-image-src="assets/img/Critical-Die/shape1.jpeg" type="button"></button></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal18" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal18" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
