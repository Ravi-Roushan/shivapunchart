...
<button aria-label="Previous image" class="product-lightbox-nav product-lightbox-prev" id="productModalPrev" type="button">‹</button>
<img class="img-fluid" id="popupImage" src=""/>
<button aria-label="Next image" class="product-lightbox-nav product-lightbox-next" id="productModalNext" type="button">›</button>
<div class="product-lightbox-counter" id="productModalCounter"></div>
</div>
</div>
</div>
</div>
...
<div class="carousel-inner"><div class="carousel-item active"><img alt="Pre-rubberized Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/pre-rubberized-die/01-pre-rubberized-die.jpg"/></div><div class="carousel-item"><img alt="Pre-rubberized Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/pre-rubberized-die/02-pre-rubberized-die.jpg"/></div><div class="carousel-item"><img alt="Pre-rubberized Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/pre-rubberized-die/03-pre-rubberized-die.jpg"/></div><div class="carousel-item"><img alt="Pre-rubberized Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/pre-rubberized-die/04-pre-rubberized-die.jpg"/></div><div class="carousel-item"><img alt="Pre-rubberized Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/pre-rubberized-die/05-pre-rubberized-die.jpg"/></div><div class="carousel-item"><img alt="Pre-rubberized Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/pre-rubberized-die/06-pre-rubberized-die.jpg"/></div></div>
...
<div class="carousel-inner"><div class="carousel-item active"><img alt="Steel Counter Plate" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/steel-counter-plate/01-steel-counter-plate.jpg"/></div><div class="carousel-item"><img alt="Steel Counter Plate" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/steel-counter-plate/02-steel-counter-plate.jpg"/></div><div class="carousel-item"><img alt="Steel Counter Plate" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/steel-counter-plate/03-steel-counter-plate.jpg"/></div><div class="carousel-item"><img alt="Steel Counter Plate" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/steel-counter-plate/04-steel-counter-plate.jpg"/></div><div class="carousel-item"><img alt="Steel Counter Plate" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/steel-counter-plate/05-steel-counter-plate.jpg"/></div></div>
...
<div class="carousel-inner"><div class="carousel-item active"><img alt="Stripping Tool" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/stripping-tool/01-stripping-tool.jpg"/></div><div class="carousel-item"><img alt="Stripping Tool" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/stripping-tool/02-stripping-tool.jpg"/></div><div class="carousel-item"><img alt="Stripping Tool" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/stripping-tool/03-stripping-tool.jpg"/></div><div class="carousel-item"><img alt="Stripping Tool" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/stripping-tool/04-stripping-tool.jpg"/></div><div class="carousel-item"><img alt="Stripping Tool" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/stripping-tool/05-stripping-tool.jpg"/></div><div class="carousel-item"><img alt="Stripping Tool" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/stripping-tool/06-stripping-tool.jpg"/></div></div>
...
<div class="carousel-inner"><div class="carousel-item active"><img alt="Embossing &amp; Debossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/embossing-debossing-die/01-embossing-debossing-die.jpg"/></div><div class="carousel-item"><img alt="Embossing &amp; Debossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/embossing-debossing-die/02-embossing-debossing-die.jpg"/></div></div>
...
<div class="carousel-inner"><div class="carousel-item active"><img alt="Braille Embossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/braille-embossing-die/01-braille-embossing-die.jpg"/></div><div class="carousel-item"><img alt="Braille Embossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/braille-embossing-die/02-braille-embossing-die.jpg"/></div><div class="carousel-item"><img alt="Braille Embossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/braille-embossing-die/03-braille-embossing-die.jpg"/></div><div class="carousel-item"><img alt="Braille Embossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/braille-embossing-die/04-braille-embossing-die.jpg"/></div><div class="carousel-item"><img alt="Braille Embossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/braille-embossing-die/05-braille-embossing-die.jpg"/></div><div class="carousel-item"><img alt="Braille Embossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/braille-embossing-die/06-braille-embossing-die.jpg"/></div><div class="carousel-item"><img alt="Braille Embossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/braille-embossing-die/07-braille-embossing-die.jpg"/></div><div class="carousel-item"><img alt="Braille Embossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/braille-embossing-die/08-braille-embossing-die.jpg"/></div><div class="carousel-item"><img alt="Braille Embossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/braille-embossing-die/09-braille-embossing-die.jpg"/></div><div class="carousel-item"><img alt="Braille Embossing Die" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/braille-embossing-die/10-braille-embossing-die.jpg"/></div></div>
...
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal15"><div class="carousel-inner"><div class="carousel-item active"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/01-3d-emboss.jpg"/></div><div class="carousel-item"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/02-3d-emboss.jpg"/></div><div class="carousel-item"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/03-3d-emboss.jpg"/></div><div class="carousel-item"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/04-3d-emboss.jpg"/></div><div class="carousel-item"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/05-3d-emboss.jpg"/></div><div class="carousel-item"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/06-3d-emboss.jpg"/></div><div class="carousel-item"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/07-3d-emboss.jpg"/></div><div class="carousel-item"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/08-3d-emboss.jpg"/></div><div class="carousel-item"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/09-3d-emboss.jpg"/></div><div class="carousel-item"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/10-3d-emboss.jpg"/></div><div class="carousel-item"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/11-3d-emboss.jpg"/></div><div class="carousel-item"><img alt="3D Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/3d-emboss/12-3d-emboss.jpg"/></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal15" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal15" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal16"><div class="carousel-inner"><div class="carousel-item active"><img alt="Punch + Emboss Online" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/punch-emboss-online/01-punch-emboss-online.jpg"/></div><div class="carousel-item"><img alt="Punch + Emboss Online" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/punch-emboss-online/02-punch-emboss-online.jpg"/></div><div class="carousel-item"><img alt="Punch + Emboss Online" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/punch-emboss-online/03-punch-emboss-online.jpg"/></div><div class="carousel-item"><img alt="Punch + Emboss Online" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/punch-emboss-online/04-punch-emboss-online.jpg"/></div><div class="carousel-item"><img alt="Punch + Emboss Online" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/punch-emboss-online/05-punch-emboss-online.jpg"/></div><div class="carousel-item"><img alt="Punch + Emboss Online" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/punch-emboss-online/06-punch-emboss-online.jpg"/></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal16" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal16" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal17"><div class="carousel-inner"><div class="carousel-item active"><img alt="Sandwich Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/sandwich-dies/01-sandwich-dies.jpg"/></div><div class="carousel-item"><img alt="Sandwich Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/sandwich-dies/02-sandwich-dies.jpg"/></div><div class="carousel-item"><img alt="Sandwich Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/sandwich-dies/03-sandwich-dies.jpg"/></div><div class="carousel-item"><img alt="Sandwich Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/sandwich-dies/04-sandwich-dies.jpg"/></div><div class="carousel-item"><img alt="Sandwich Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/sandwich-dies/05-sandwich-dies.jpg"/></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal17" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal17" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal18"><div class="carousel-inner"><div class="carousel-item active"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/blanking-die-male-female/01-blanking-die-male-female.jpg"/></div><div class="carousel-item"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/blanking-die-male-female/02-blanking-die-male-female.jpg"/></div><div class="carousel-item"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/blanking-die-male-female/03-blanking-die-male-female.jpg"/></div><div class="carousel-item"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/blanking-die-male-female/04-blanking-die-male-female.jpg"/></div><div class="carousel-item"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/blanking-die-male-female/05-blanking-die-male-female.jpg"/></div><div class="carousel-item"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/blanking-die-male-female/06-blanking-die-male-female.jpg"/></div><div class="carousel-item"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/blanking-die-male-female/07-blanking-die-male-female.jpg"/></div><div class="carousel-item"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/blanking-die-male-female/08-blanking-die-male-female.jpg"/></div><div class="carousel-item"><img alt="Blanking Die Male Female" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/blanking-die-male-female/09-blanking-die-male-female.jpg"/></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal18" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal18" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal19"><div class="carousel-inner"><div class="carousel-item active"><img alt="Creasing Counter Plate" class="d-block w-100 product-img" src="assets/img/Steel-Counter-Plate/S1.jpg"/><button aria-label="View Creasing Counter Plate" class="product-image-click-target" data-image-alt="Creasing Counter Plate" data-image-src="assets/img/Steel-Counter-Plate/S1.jpg" type="button"></button></div><div class="carousel-item"><img alt="Creasing Counter Plate" class="d-block w-100 product-img" src="assets/img/Steel-Counter-Plate/S2.jpg"/><button aria-label="View Creasing Counter Plate" class="product-image-click-target" data-image-alt="Creasing Counter Plate" data-image-src="assets/img/Steel-Counter-Plate/S2.jpg" type="button"></button></div><div class="carousel-item"><img alt="Creasing Counter Plate" class="d-block w-100 product-img" src="assets/img/Steel-Counter-Plate/S3.jpg"/><button aria-label="View Creasing Counter Plate" class="product-image-click-target" data-image-alt="Creasing Counter Plate" data-image-src="assets/img/Steel-Counter-Plate/S3.jpg" type="button"></button></div><div class="carousel-item"><img alt="Creasing Counter Plate" class="d-block w-100 product-img" src="assets/img/Steel-Counter-Plate/S4.jpg"/><button aria-label="View Creasing Counter Plate" class="product-image-click-target" data-image-alt="Creasing Counter Plate" data-image-src="assets/img/Steel-Counter-Plate/S4.jpg" type="button"></button></div><div class="carousel-item"><img alt="Creasing Counter Plate" class="d-block w-100 product-img" src="assets/img/Steel-Counter-Plate/S5.jpg"/><button aria-label="View Creasing Counter Plate" class="product-image-click-target" data-image-alt="Creasing Counter Plate" data-image-src="assets/img/Steel-Counter-Plate/S5.jpg" type="button"></button></div><div class="carousel-item"><img alt="Creasing Counter Plate" class="d-block w-100 product-img" src="assets/img/Steel-Counter-Plate/S6.jpg"/><button aria-label="View Creasing Counter Plate" class="product-image-click-target" data-image-alt="Creasing Counter Plate" data-image-src="assets/img/Steel-Counter-Plate/S6.jpg" type="button"></button></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal19" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal19" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal21"><div class="carousel-inner"><div class="carousel-item active"><img alt="Mag Etg Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/mag-etg-foil-block/01-mag-etg-foil-block.jpg"/></div><div class="carousel-item"><img alt="Mag Etg Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/mag-etg-foil-block/02-mag-etg-foil-block.jpg"/></div><div class="carousel-item"><img alt="Mag Etg Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/mag-etg-foil-block/03-mag-etg-foil-block.jpg"/></div><div class="carousel-item"><img alt="Mag Etg Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/mag-etg-foil-block/04-mag-etg-foil-block.jpg"/></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal21" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal21" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal22"><div class="carousel-inner"><div class="carousel-item active"><img alt="Texter Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/texter-foil-block/01-texter-foil-block.jpg"/></div><div class="carousel-item"><img alt="Texter Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/texter-foil-block/02-texter-foil-block.jpg"/></div><div class="carousel-item"><img alt="Texter Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/texter-foil-block/03-texter-foil-block.jpg"/></div><div class="carousel-item"><img alt="Texter Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/texter-foil-block/04-texter-foil-block.jpg"/></div><div class="carousel-item"><img alt="Texter Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/texter-foil-block/05-texter-foil-block.jpg"/></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal22" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal22" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal23"><div class="carousel-inner"><div class="carousel-item active"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/01-cnc-foil-block.png"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/02-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/03-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/04-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/05-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/06-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/07-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/08-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/09-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/10-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/11-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/12-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/13-cnc-foil-block.jpg"/></div><div class="carousel-item"><img alt="CNC Foil Block" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/cnc-foil-block/14-cnc-foil-block.jpeg"/></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal23" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal23" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal24"><div class="carousel-inner"><div class="carousel-item active"><img alt="Foil + Emboss One Shot" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/foil-emboss-one-shot/01-foil-emboss-one-shot.jpg"/></div><div class="carousel-item"><img alt="Foil + Emboss One Shot" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/foil-emboss-one-shot/02-foil-emboss-one-shot.jpg"/></div><div class="carousel-item"><img alt="Foil + Emboss One Shot" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/foil-emboss-one-shot/03-foil-emboss-one-shot.jpg"/></div><div class="carousel-item"><img alt="Foil + Emboss One Shot" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/foil-emboss-one-shot/04-foil-emboss-one-shot.jpg"/></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal24" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal24" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal25"><div class="carousel-inner"><div class="carousel-item active"><img alt="Micro Effect Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/micro-effect-dies/01-micro-effect-dies.jpg"/></div><div class="carousel-item"><img alt="Micro Effect Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/micro-effect-dies/02-micro-effect-dies.jpg"/></div><div class="carousel-item"><img alt="Micro Effect Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/micro-effect-dies/03-micro-effect-dies.jpg"/></div><div class="carousel-item"><img alt="Micro Effect Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/micro-effect-dies/04-micro-effect-dies.jpg"/></div><div class="carousel-item"><img alt="Micro Effect Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/micro-effect-dies/05-micro-effect-dies.jpg"/></div><div class="carousel-item"><img alt="Micro Effect Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/micro-effect-dies/06-micro-effect-dies.jpg"/></div><div class="carousel-item"><img alt="Micro Effect Dies" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/micro-effect-dies/07-micro-effect-dies.jpg"/></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal25" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal25" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<div class="col-lg-4 col-md-6 mb-30">
<div class="info-box-1"><div class="info-box-1-inner">
<div class="carousel slide" data-bs-ride="carousel" id="productCarouselFinal26"><div class="carousel-inner"><div class="carousel-item active"><img alt="Step Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/step-emboss/01-step-emboss.jpg"/></div><div class="carousel-item"><img alt="Step Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/step-emboss/02-step-emboss.jpg"/></div><div class="carousel-item"><img alt="Step Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/step-emboss/03-step-emboss.jpg"/></div><div class="carousel-item"><img alt="Step Emboss" class="d-block w-100 product-img" data-bs-target="#imageModal" data-bs-toggle="modal" onclick="showImage(this.src)" src="assets/img/our-products/step-emboss/04-step-emboss.jpg"/></div></div><button aria-label="Previous image" class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#productCarouselFinal26" type="button"><span aria-hidden="true" class="carousel-control-prev-icon"></span></button><button aria-label="Next image" class="carousel-control-next" data-bs-slide="next" data-bs-target="#productCarouselFinal26" type="button"><span aria-hidden="true" class="carousel-control-next-icon"></span></button></div>
...
<style id="all-19-product-scroller-final">
.our-products-grid .carousel-control-prev,.our-products-grid .carousel-control-next,.carousel[id^="productCarouselFinal"] .carousel-control-prev,.carousel[id^="productCarouselFinal"] .carousel-control-next{display:flex!important;align-items:center!important;justify-content:center!important;width:30px!important;height:34px!important;top:50%!important;transform:translateY(-50%)!important;border:0!important;border-radius:7px!important;background:rgba(24,67,93,.82)!important;opacity:.98!important;z-index:6!important;}
.our-products-grid .carousel-control-prev,.carousel[id^="productCarouselFinal"] .carousel-control-prev{left:5px!important}.our-products-grid .carousel-control-next,.carousel[id^="productCarouselFinal"] .carousel-control-next{right:5px!important}
